...
const LearningGrid = () => {
  return (
    <div className="grid mx-auto grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mb-10 p-5 lg:w-fit">
      {LearningGridArray.map((card, index) => {
        return (
          ...
          >
            {card.order < 0 ? (
              <div className="h-[250px] lg:w-[90%] flex flex-col pb-5 gap-3" >
